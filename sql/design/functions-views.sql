select title from staging_movie;
...
FROM '/home/joeversoza/Downloads/us_counties_2010.csv.txt'
...
FROM '/home/joeversoza/Downloads/us_counties_2000.csv.txt'
WITH (FORMAT CSV, HEADER);


select geo_name, state_us_abbreviation from us_counties_2000
where geo_name ilike '%butler%';
